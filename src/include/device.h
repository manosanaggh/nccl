...
struct alignas(16) ncclDevWorkColl {
  ...
  uint64_t redOpArg;
  uint32_t measureOpSlot;
  uint32_t measureFunc;
  uint64_t measureCollBytes;
};
...
enum ncclRingPrimMeasureStatIndex {
  NCCL_RING_PRIM_STATS_STAGING_COUNT = 0,
  NCCL_RING_PRIM_STATS_STAGING_BYTES = 1,
  NCCL_RING_PRIM_STATS_STAGING_NS = 2,
  NCCL_RING_PRIM_STATS_KERNEL_CHANNEL_COUNT = 3,
  NCCL_RING_PRIM_STATS_KERNEL_CHANNEL_NS = 4,
  NCCL_RING_PRIM_STATS_SYNC_BASE = 5,
  NCCL_RING_PRIM_STATS_SYNC_FIELDS = 2,
  NCCL_RING_PRIM_STATS_SYNC_COUNT = 0,
  NCCL_RING_PRIM_STATS_SYNC_NS = 1,
  NCCL_RING_SYNC_WAIT_SEND = 0,
  NCCL_RING_SYNC_WAIT_RECV = 1,
  NCCL_RING_SYNC_BARRIER = 2,
  NCCL_RING_SYNC_SUBBARRIER = 3,
  NCCL_RING_SYNC_POST_PEER = 4,
  NCCL_RING_SYNC_POST_FENCE = 5,
  NCCL_RING_SYNC_NUM = 6,
  NCCL_RING_PRIM_STATS_SYNC_CHANNEL_BASE = NCCL_RING_PRIM_STATS_SYNC_BASE + NCCL_RING_SYNC_NUM * NCCL_RING_PRIM_STATS_SYNC_FIELDS,
  NCCL_RING_PRIM_STATS_SYNC_CHANNEL_STRIDE = NCCL_RING_SYNC_NUM * NCCL_RING_PRIM_STATS_SYNC_FIELDS,
  NCCL_RING_PRIM_STATS_STAGING_CHANNEL_BASE = NCCL_RING_PRIM_STATS_SYNC_CHANNEL_BASE + MAXCHANNELS * NCCL_RING_PRIM_STATS_SYNC_CHANNEL_STRIDE,
  NCCL_RING_PRIM_STATS_STAGING_CHANNEL_FIELDS = 3,
  NCCL_RING_PRIM_STATS_ROUNDTRIP_CHANNEL_BASE = NCCL_RING_PRIM_STATS_STAGING_CHANNEL_BASE + MAXCHANNELS * NCCL_RING_PRIM_STATS_STAGING_CHANNEL_FIELDS,
  NCCL_RING_PRIM_STATS_ROUNDTRIP_CHANNEL_FIELDS = 3,
  NCCL_RING_PRIM_STATS_ROUNDTRIP_COUNT = 0,
  NCCL_RING_PRIM_STATS_ROUNDTRIP_NS = 1,
  NCCL_RING_PRIM_STATS_ROUNDTRIP_MAX_NS = 2,
  NCCL_RING_PRIM_STATS_PRIM_BASE = NCCL_RING_PRIM_STATS_ROUNDTRIP_CHANNEL_BASE + MAXCHANNELS * NCCL_RING_PRIM_STATS_ROUNDTRIP_CHANNEL_FIELDS,
  NCCL_RING_PRIM_STATS_PRIM_FIELDS = 6,
  NCCL_RING_PRIM_STATS_PRIM_COUNT = 0,
  NCCL_RING_PRIM_STATS_PRIM_BYTES = 1,
  NCCL_RING_PRIM_STATS_PRIM_NS = 2,
  NCCL_RING_PRIM_STATS_PRIM_NET_COUNT = 3,
  NCCL_RING_PRIM_STATS_PRIM_NET_BYTES = 4,
  NCCL_RING_PRIM_STATS_PRIM_NET_NS = 5,
  NCCL_RING_PRIM_AG_DIRECT_SEND = 0,
  NCCL_RING_PRIM_AG_DIRECT_COPY_SEND = 1,
  NCCL_RING_PRIM_AG_DIRECT_RECV_COPY_DIRECT_SEND = 2,
  NCCL_RING_PRIM_AG_DIRECT_RECV = 3,
  NCCL_RING_PRIM_AG_LOCAL_REDUCE_COPY = 4,
  NCCL_RING_PRIM_RS_SEND = 5,
  NCCL_RING_PRIM_RS_RECV_REDUCE_SEND = 6,
  NCCL_RING_PRIM_RS_RECV_REDUCE_COPY = 7,
  NCCL_RING_PRIM_STATS_NUM_PRIMS = 8,
  NCCL_RING_PRIM_OP_STATS_MAX = NCCL_MAX_OPS,
  NCCL_RING_PRIM_OP_META_BASE = NCCL_RING_PRIM_STATS_PRIM_BASE + NCCL_RING_PRIM_STATS_NUM_PRIMS * NCCL_RING_PRIM_STATS_PRIM_FIELDS,
  NCCL_RING_PRIM_OP_META_FIELDS = 5,
  NCCL_RING_PRIM_OP_META_VALID = 0,
  NCCL_RING_PRIM_OP_META_FUNC = 1,
  NCCL_RING_PRIM_OP_META_BYTES = 2,
  NCCL_RING_PRIM_OP_META_CHANNEL_LO = 3,
  NCCL_RING_PRIM_OP_META_CHANNEL_HI = 4,
  NCCL_RING_PRIM_OP_SYNC_CHANNEL_BASE = NCCL_RING_PRIM_OP_META_BASE + NCCL_RING_PRIM_OP_STATS_MAX * NCCL_RING_PRIM_OP_META_FIELDS,
  NCCL_RING_PRIM_OP_SYNC_CHANNEL_STRIDE = NCCL_RING_SYNC_NUM * NCCL_RING_PRIM_STATS_SYNC_FIELDS,
  NCCL_RING_PRIM_OP_STAGING_CHANNEL_BASE = NCCL_RING_PRIM_OP_SYNC_CHANNEL_BASE + NCCL_RING_PRIM_OP_STATS_MAX * MAXCHANNELS * NCCL_RING_PRIM_OP_SYNC_CHANNEL_STRIDE,
  NCCL_RING_PRIM_OP_STAGING_CHANNEL_STRIDE = NCCL_RING_PRIM_STATS_STAGING_CHANNEL_FIELDS,
  NCCL_RING_PRIM_STATS_LEN = NCCL_RING_PRIM_OP_STAGING_CHANNEL_BASE + NCCL_RING_PRIM_OP_STATS_MAX * MAXCHANNELS * NCCL_RING_PRIM_OP_STAGING_CHANNEL_STRIDE
};
